...
public class Date
{
    ...
    public String Date(int myMonth, int myDay, int myYear)
    {
		...
		switch(myMonth)
		{
			...
			case 2: if(myYear%4==0 && myYear%400!=0){
						maxday=29;break;}
					else{
						maxday=28;break;}
}
			if((myMonth>=1&&myMonth<=12) && (myDay>=1&&myDay<=maxday) && (myYear>=1000&&myYear<=9999)){
					day=myDay;month=monthString(myMonth);year=myYear;
